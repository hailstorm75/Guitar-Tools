...
namespace FretboardLibrary
{
  ...
  public class FretNote : UserControl
  {
    ...
    {
      get { return tone; }
      set { tone = ToneProducer.GetHertz(value); }
    }
    ...
    private readonly CircularLabel note;

    /// <summary>
    ///     Set of music keys
    /// </summary>
    private static readonly string[] MusicKeys = { "C", "C♯", "D", "D♯", "E", "F", "F♯", "G", "G♯", "A", "A♯", "B" };
    ...
    public void ShiftTuning(int shiftTo)
    {
      ...
      Tone = ToneProducer.GetHertz(shiftTo);
    ...
    {
      var interval = new IntLimited(Index - Root, 0, 12);

      note.Alt = (from node in XDocument.Load(Directory.GetCurrentDirectory() + @"\Data\Data.xml")
